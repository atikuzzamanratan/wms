            ...
            <div class="col-lg-8 mb-0">
                <section class="card">
                        ...
                        <form name="editForm" class="form-horizontal form-bordered" action="" method="post">
                                ...
                                foreach ($MasterDataQueryRS as $row) {
									...
									<?php
										if ($row->Comments != '' && $row->IsCorrected) {
											echo '<img class="jBoxTip imgComments" src="../img/Comments.png" border=0 style="cursor: pointer;width: 60px;height:60px;" width="60px" height="60px" title=\''.$row->Comments.'\'>';
											echo '<img class="correctIdentifier" src="../img/Correct.png" style="width: 60px;height:60px;display:none;" border="0" width="60px" height="60px">';
										}
									?>
                                        <?php
										if ($IsEditable == 0) {
                            ...
                            <footer class="card-footer">
                                <div class="row justify-content-end">
                                    <div class="col-lg-9">
										<input class="btn btn-primary nonSmbButton" type="submit" value="Update" name="update" style="display:none;">
                                        <input class="btn btn-primary jBoxTip smbButton" value="Update" title="Please modify the Commented value(s) First">
                    ...
                    if ($_REQUEST['update'] === 'Update') {
                        $FirstArray = $_REQUEST;
                        $sqlQry = "";
						$currentUserName = getValue('userinfo', 'UserName', "id = $loggedUserID");
									...
									*/
									...
									if ($value != $DataValue) {
										if ($value != '') {
											...
											$sqlQry .= " UPDATE masterdatarecord_UnApproved SET ColumnValue = N'$value', Comments=COALESCE(Comments, '')+N'$comm', IsEdited=(COALESCE(IsEdited, 0)+1) WHERE id = '$MainID'; ";
										}
										if ($ColumnName == "PSU") {
											$sqlQry .= " UPDATE masterdatarecord_UnApproved SET PSU = '$value' WHERE XFormRecordId = '$RecordID'; ";
