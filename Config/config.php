...
$projectDescription3= "বাংলাদেশ পরিসংখ্যান ব্যুরো<br>
স্ট্যাটিস্টিক্যাল ক্যাপাসিটি এনহ্যান্সমেন্ট অ্যান্ড মডার্নাইজেশন প্রজেক্ট (এসসিইএমপি)<br>
Statistical Capacity Enhancement and Modernization Project (SCEMP)
";
