        ...
        <div class="row">
            <div class="col-lg-12 mb-0">
                ...
                if ($_REQUEST['show'] === 'Show') {
                    ...
                    $dataURL = $baseURL . "Authentication/ajax-data/supervisor-list-ajax-data.php?ci=$SelectedCompanyID&lun=$loggedUserName";
...
<script type="text/javascript">
    function DeleteItem(id, data) {
        if (confirm("Are you sure to delete this data?")) {
            $.ajax({
                url: "Authentication/supervisor-asign-delete.php",
                method: "GET",
                datatype: "json",
                data: {
                    id: id,
