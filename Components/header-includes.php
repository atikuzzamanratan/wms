...
<!-- Developer Includs -->
<script src="../js/AjaxFunctionHandler.js"></script>
...
<script async defer src="https://maps.googleapis.com/maps/api/js?key=<?php echo $googleMapApiKey; ?>"></script>
...
<!-- Include Form Submit Field Populate Script -->
