        ...
        <div class="row">
            <div class="col-lg-12 mb-0">
                ...
                if ($_REQUEST['show'] === 'Show') {
                    ...
                    if ($check == "chkAll") {
                        $dataURL = $baseURL . 'CompanyInfo/ajax-data/package-history-ajax-data.php?par=1';
                    } else {
                        $dataURL = $baseURL . 'CompanyInfo/ajax-data/package-history-ajax-data.php?par=0&id=' . $CompanyID;
                    }
